...
import { LoginResponse, SignUpResponse } from "src/common/interfaces/login.interface";
...
export class AuthController {
    ...
    @Post('/signUp')
    async signUp(@Body(new ValidationPipe()) signUpDto: SignUpDto): Promise<SignUpResponse> {
